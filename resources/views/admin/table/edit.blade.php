...
<div class="container px-6 mx-auto grid">
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
    <form class="w-full max-w-lg" action="{{URL('update-table/'.$table->id)}}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="flex flex-wrap -mx-3 mb-3">
        ...
        <div class="w-full md:w-1/2 px-3">
          ...
          <input value="{{$table->chairs}}" name="chairs" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" placeholder="Enter the chair count">
        </div>
        <div class="w-full md:w-1/2 px-3">
